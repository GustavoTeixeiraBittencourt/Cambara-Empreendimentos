...
Tela inicial após o login. Responde às **4 perguntas de negócio do teste**, uma por aba, cada uma calculada em `app/analytics/` (nunca com número fixo digitado na tela):
